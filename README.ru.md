...
**ThermalLabeler** — программа для печати на термопринтерах из Android без привязки к производителю и без использования фирменных драйверов.

<p align="center">
  <img src="images/roll.jpg" alt="Receipt roll" width="300">
</p>

Важно: приложение предназначено исключительно для работы с термопринтерами, поддерживающими режимы <b>TSPL</b> и/или <b>ESC/POS</b>:
<ul>
  <li><b>TSPL</b> - используется для печати на самоклеящихся этикетках
  <li><b>ESC/POS</b> - используется для печати на рулонной термобумаге (чеки, квитанции, талоны и другие документы)
</ul>
Программа не предназначена для обычных офисных, струйных, лазерных и других типов принтеров и не работает с ними. Поддерживаются только термопринтеры с совместимым интерфейсом печати <b>TSPL</b> и <b>ESC/POS</b>.
<BR>
...
- печать чеков и других документов на чековой ленте
