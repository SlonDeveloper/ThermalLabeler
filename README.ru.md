...
<BR>
<BR>Программа является мостом между Android и термопринтером и даёт полный контроль над печатью этикеток там, где стандартные решения не работают или мешают. Приложение решает практическую задачу: как напечатать этикетку или содержимое чека с телефона или планшета на обычном термопринтере.
<BR>
