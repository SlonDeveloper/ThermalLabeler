...
<BR>Далее, в случае печати этикетки, масштабируется под ее реальные размеры и подготавливается с учётом ориентации, отступов и параметров принтера.
<BR>Если же печать происходит на чековом принтере, то полученный растровый макет масштабируется по ширине бумаги.
