...
Программа не предназначена для обычных офисных, струйных, лазерных и других типов принтеров и не работает с ними. Поддерживаются только термопринтеры с совместимым интерфейсом печати **TSPL** и/или **ESC/POS**.
<BR>
