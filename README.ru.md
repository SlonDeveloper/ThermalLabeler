...
<BR>
<ul>
  <li><b></b>TSPL</b> - используется для печати на самоклеящихся этикетках</ul>
  <li><b>ESC/POS</b> - используется для печати на рулонной термобумаге (чеки, квитанции, талоны и другие документы)</ul>
</ul>
<BR>
